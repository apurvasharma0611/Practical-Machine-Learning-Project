...
set.seed(3355)
training <- read.csv("C:/Users/Apurva/Desktop/Practical-Machine-Learning-Project/pml-training.csv", header = TRUE, na.strings=c("NA","#DIV/0!",""))
test <- read.csv("C:/Users/Apurva/Desktop/Practical-Machine-Learning-Project/pml-testing.csv", header = TRUE, na.strings=c("NA","#DIV/0!",""))
